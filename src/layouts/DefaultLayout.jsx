  ...
  return (
    <div id="defaultLayout" className="relative w-full h-screen mainScrollBar">
      ...
      <button
        ...
        className="absolute z-0 md:bottom-80 bottom-16 xl:left-28 md:left-16 left-10 font-barlow text-2xl bg-[#1a2228] hover:bg-[#222d35] text-white px-6 py-3 rounded-xl"
      >
